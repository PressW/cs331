...
public:
    ...
    std::vector<OthelloBoard*> successors(char p_symbol, OthelloBoard *b);
    int max_value(int &row, int &col, char p_symbol, OthelloBoard *b);
    int min_value(int &row, int &col, char p_symbol, OthelloBoard *b);
